...
#' @author sd11
#' @export
cnfit_to_refit_suggestions = function(samplename, subclones_file, rho_psi_file, gamma_param, min_segment_size_mb=2, RHO, PSI, solution_type) {
  ...
  write.table(output, file=paste0(samplename, "_", solution_type, "_psi", PSI, "_rho", RHO, "_refit_suggestion.txt"), quote=F, sep="\t", row.names=F)
}
